                ...
                <form className="w-full flex justify-between items-center" onSubmit={handleCheck}>
                    ...
                    <div className="flex items-center text-slate-500">
                        ...
                        <ul className="flex justify-between items-center text-2xl">
                            <li>
                                <input disabled type="text" id="adults" className="w-8 text-center bg-transparent" />
                                Adults
                            </li>
                            <li>
                                <input disabled type="text" id="children" className="w-8 text-center bg-transparent" />
                                Children
                            </li>
                            <li>
                                <input disabled type="text" id="rooms" className="w-8 text-center bg-transparent" />
                                Rooms
                            </li>
                        </ul>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
